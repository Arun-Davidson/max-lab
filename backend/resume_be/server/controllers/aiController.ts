...
export const enhanceProfessionalSummary = async (req: Request, res: Response) => {
    try {
...
export const enhanceJobDescription = async (req: Request, res: Response) => {
    try {
        const { userContent } = req.body;
